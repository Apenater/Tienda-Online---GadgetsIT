    ...
    ID_OFERTA = document.getElementById('id_oferta'),  
    ...
    SAVE_FORM.addEventListener('submit', async (event) => {
        ...
        (id_oferta.value) ? action = 'updateRow' : action = 'createRow';
        // Constante tipo objeto con los datos del formulario.
    ...
    const fillTable = async (form = null) => {
        ...
        if (DATA.status) {
            ...
            <div class="gadgetit-card">
                ...
                <button type="button" class="gadgetit-btn gadgetit-btn-verde"  onclick="openUpdate(${row.id_oferta})">
                <img src="../../resources/img/actualizar.svg" alt="Actualizar" class="gadgetit-btn-icon">
                Actualizar
                    </button>
                        <button type="button" class="gadgetit-btn gadgetit-btn-rojo" onclick="openDelete(${row.id_oferta})">
