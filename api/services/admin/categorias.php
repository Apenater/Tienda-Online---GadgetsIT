    ...
    if (isset($_SESSION['id_admin'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    !$categoria->setNombre($_POST['nombreC']) or
                    !$categoria->setDescripcion($_POST['Descripcion']) or
                    !$categoria->setImagen($_FILES['foto'])
                ) {
                    ...
                    $result['fileStatus'] = Validator::saveFile($_FILES['foto'], $categoria::RUTA_IMAGEN);
                } else {
            ...
            case 'updateRow':
                ...
                if (
                    ...
                    !$categoria->setNombre($_POST['nombreC']) or
                    !$categoria->setDescripcion($_POST['Descripcion']) or
                    !$categoria->setImagen($_FILES['foto'], $categoria->getFilename())
                ) {
                    $result['error'] = $categoria->getDataError();
                    ...
                    $result['fileStatus'] = Validator::changeFile($_FILES['foto'], $categoria::RUTA_IMAGEN, $categoria->getFilename());
                } else {
