        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    ...
                    !$categoria->setDescripcion($_POST['descripcionMarca']) or
                    !$categoria->setImagen($_FILES['imagenMarca'])
                ) {
                    ...
                    $result['fileStatus'] = Validator::saveFile($_FILES['imagenMarca'], $categoria::RUTA_IMAGEN);
                } else {
            ...
            case 'updateRow':
                ...
                if (
                    ...
                    !$categoria->setNombre($_POST['nombreMarca']) or
                    !$categoria->setDescripcion($_POST['descripcionMarca']) or
                    !$categoria->setImagen($_FILES['imagenMarca'], $categoria->getFilename())
                ) {
                    $result['error'] = $categoria->getDataError();
                } elseif ($categoria->updateRow()) {
                    $result['status'] = 1;
                    $result['message'] = 'Categoría modificada correctamente';
                    $result['fileStatus'] = Validator::changeFile($_FILES['imagenMarca'], $categoria::RUTA_IMAGEN, $categoria->getFilename());
                } else {
