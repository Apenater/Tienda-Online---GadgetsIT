...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/Tienda-Online---GadgetsIT/views/admin/';
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['idAdministrador'])) {
            ...
            $this->setTitle('GadgetsIT - Reporte', true);
...
{
    const CLIENT2_URL = 'http://localhost/Tienda-Online---GadgetsIT/views/public/';
