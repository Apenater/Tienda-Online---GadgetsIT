...
$marca = new MarcaHandler;

// Se verifica si existen registros para mostrar, de lo contrario se imprime un mensaje.
if ($datamarcas = $marca->readAll()) {
    // Se inicia el reporte con el encabezado del documento.
    $pdf->startReport('Listado de marcas');
    ...
    // Se establece la fuente para los datos de los marcaes.
    ...
    foreach ($datamarcas as $rowmarca) {
        // Se imprimen las celdas con los datos de los marcaes.
        $pdf->setFillColor($fill ? 230 : 255); // Color de relleno gris más claro y blanco alternante
        $pdf->cell(40, 10, $pdf->encodeString($rowmarca['nombre_marca']), 1, 0, '', $fill);
        $pdf->cell(100, 10, $pdf->encodeString($rowmarca['descripcion_marca']), 1, 1, '', $fill);
    ...
    print('No hay marcaes para mostrar');
}
?>
